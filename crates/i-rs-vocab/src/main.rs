...
use commands::{handle_add, handle_delete, handle_example, handle_get, handle_list, handle_quiz, handle_skill, handle_stats, handle_update, parse_skill_arg};
...
fn run(command: Commands, format: OutputFormat) -> anyhow::Result<()> {
    match command {
        Commands::Add { word, definition, example, status, tag, remark } => {
        ...
        Commands::Update { word, definition, example, status, tag, remark, review } => {
